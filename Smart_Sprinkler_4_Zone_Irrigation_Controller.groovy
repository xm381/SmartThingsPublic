...
preferences {
    ...
    input("oneTimer", "Integer", title: "Zone One", description: "Zone One Time", required: false, defaultValue: "1")
    input("twoTimer", "Integer", title: "Zone Two", description: "Zone Two Time", required: false, defaultValue: "1")
    input("threeTimer", "Integer", title: "Zone Three", description: "Zone Three Time", required: false, defaultValue: "1")
    input("fourTimer", "Integer", title: "Zone Four", description: "Zone Four Time", required: false, defaultValue: "1")
}
